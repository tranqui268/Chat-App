...
class _MessagePageState extends State<MessagePage> {
      ...
      body: Column(children: [
        ...
        Container(
          ...
          child: ListView(
            ...
            children: [
              _buildMyInfo(
                  context,
                  "https://res.cloudinary.com/dhis8yzem/image/upload/v1741011247/chatApp/Avatar_default.png",
                  ""),
              _buildRecentContact(
                  "test",
                  "https://res.cloudinary.com/dhis8yzem/image/upload/v1741011247/chatApp/Avatar_default.png",
                  "hôm nay vui quá hhhhhhhhhhh",
                  true,
                  context),
              _buildRecentContact(
                  "test",
        ...
        Expanded(
          ...
          builder: (context, state) {
            if (state is ConversationLoading) {
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index){
                  ...
                  final user = state.users[conversation.members[1]];
                  print(conversation.id);
                  return GestureDetector(
                          onTap: () {
                            Navigator.push(
                                context, MaterialPageRoute(builder: (_) => ChatPage(conservationId: conversation.id,mate: user!.name,)));
                          },
            ...
            return const Center(child: Text('No conservation'),);
  ...
  Widget _buildRecentContact(String name, String url, String note,
  ...
  Widget _buildMessageTitle(
      String name, String message, String url, String time, bool isOnline) {
    return ListTile(
